...
# This program is using yolov3-tiny model which is much smaller than original Yolo model.
# This allows for max 15 FPS when CPU is used for inference.
# But the performance is also very poor because of small size. Its a tradeoff of inference time and performance.
